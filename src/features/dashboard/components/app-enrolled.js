            ...
            <div class=" gap-4 content-center mt-6 justify-center md:justify-between">
                <div class="gap-8 mt-6 md:flex md:justify-between">
                    ...
                    <div class="flex justify-center py-1 pt-2">
                        <a href="/courses-view" data link class="bg-[#3498db] hover:bg-blue-400 text-white font-bold py-3 px-3 rounded shadow-lg transform transition-transform duration-900 hover:-translate-y-0.5 hover:shadow-xl w-full">Browse More Courses</a>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-6 rounded">
                    ${filteredCourse.map(course => {
                        return `
                        <div class="bg-white shadow-md rounded-2 transform h-[360px] rounded-lg transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl">
